namespace DemoExTkani
{
    partial class Zakaz
    {
        ...
        private void InitializeComponent()
        {
            ...
            this.заказTableAdapter = new DemoExTkani.DemoExDataSet1TableAdapters.ЗаказTableAdapter();
            ...
            // 
            this.этапВыполненияDataGridViewTextBoxColumn.DataPropertyName = "Этап выполнения";
            ...
            this.заказBindingSource.DataSource = this.bindingSource1;
            // 
            // заказTableAdapter
            // 
        ...
        private DemoExDataSet1TableAdapters.ЗаказTableAdapter заказTableAdapter;
